/*
 Basic Primitives orgDiagram v2.0.5 (c) Basic Primitives Inc
...
primitives.common.attr = function (a, b) {
    var c, d;
    if (a.hasOwnProperty("attrHash")) for (c in b) b.hasOwnProperty(c) && (d = b[c], a.attrHash[c] != d && (a.attrHash[c] = d, a.attr(c, d)));
    else a.attr(b), a.attrHash = b
};
primitives.common.css = function (a, b) {
    var c, d;
    if (a.hasOwnProperty("cssHash")) for (c in b) b.hasOwnProperty(c) && (d = b[c], a.cssHash[c] != d && (a.cssHash[c] = d, a.css(c, d)));
...
primitives.common.indexOf = function (a, b) {
    var c, d;
    for (c = 0; c < a.length; c += 1) if (d = a[c], d === b) return c;
    return -1
};
...
primitives.common.BaseShape.prototype._getLabelPosition = function (a, b, c, d, e, g, f, h) {
    ...
    case 12:
        ...
        break;
    case 4:
        j = new primitives.common.Rect(a + c - e, b + d + f, e, g);
        break;
    case 6:
...
primitives.common.BaseShape.prototype._getArrow = function (a, b, c, d, e) {
    ...
    g.push(new primitives.common.LineSegment(i[2].x, i[2].y));
...
primitives.common.Callout.prototype.draw = function (a, b) {
    var b = (new primitives.common.Rect(b)).offset(this.offset),
        ...
        h;
    null !== a && (c = 0 === this.pointerPlacement ? this._getPlacement(a, c, e) : this.pointerPlacement, null !== c && (f[c] = a));
    c = [];
...
primitives.common.Connector.prototype.draw = function (a, b, c) {
    ...
    u = Math.max(this.hasLabel ? t.width : 0, 5 * j);
    if (a.right() + u < b.left() || a.left() > b.right() + u) if (a.left() > b.right() ? (d = new primitives.common.Point(a.left(), a.verticalCenter()), e = new primitives.common.Point(b.right(), b.verticalCenter()), u = 7, v = 3) : (d = new primitives.common.Point(a.right(), a.verticalCenter()), e = new primitives.common.Point(b.left(), b.verticalCenter()), u = 3, v = 7), g = new primitives.common.Rect(d, e), p = d.y <= e.y, n = d.x < e.x, g.height < g.width) {
        g.height < 2 * j && g.offset(0, p ? 2 * j : 0, 0, p ? 0 : 2 * j);
        i = 0;
        for (k = l.length; i < k; i += 1) m = l[i], f.push(new primitives.common.MoveSegment(d.x, d.y + m)), f.push(new primitives.common.QuadraticArcSegment(g.horizontalCenter(), (p ? g.top() : g.bottom()) + m, e.x, e.y + m));
        ...
        i = 0;
        for (k = l.length; i < k; i += 1) m = l[i], f.push(new primitives.common.MoveSegment(d.x, d.y + m)), f.push(new primitives.common.QuadraticArcSegment(g.horizontalCenter() + m * (p != n ? 1 : -1), (p ? g.top() : g.bottom()) + m, g.horizontalCenter() + m * (p != n ? 1 : -1), g.verticalCenter() + m)), f.push(new primitives.common.QuadraticArcSegment(g.horizontalCenter() + m * (p != n ? 1 : -1), (p ? g.bottom() : g.top()) + m, e.x, e.y + m));
        ...
        e = new primitives.common.Point(n ? b.right() : b.left(), b.verticalCenter());
        v = u = n ? 3 : 7;
        ...
        s = new primitives.common.Rect(l.x + (n ? q / 2 : -q / 2 - t.width), l.y - t.height / 2, t.width, t.height)
    } else {
        ...
        l = this._quadraticBezierPoint(d, new primitives.common.Point(g.horizontalCenter(), g.top()), e, 0.5);
    ...
    if (0 < f.length) {
        ...
        case 1:
            ...
            h = h.concat(this._getArrow(q.x, q.y, j, r, n));
        ...
        if (this.hasLabel) {
            ...
            this.transform.transformRect(s.x, s.y, s.width, s.height, !0, this, function (a, b, c, d) {
...
primitives.common.Shape.prototype.draw = function (a, b) {
    ...
    default:
        ...
        case 1:
            ...
            c.push(new primitives.common.MoveSegment(a.x, a.verticalCenter()));
            ...
            c.push(new primitives.common.CubicArcSegment(a.horizontalCenter() - d, a.bottom(), a.x, a.verticalCenter() + g, a.x, a.verticalCenter()));
            break;
        case 5:
    ...
    this.hasLabel && this.m_graphics.template(e.x, e.y, 0, 0, 0, 0, e.width, e.height, this.labelTemplate, this.labelTemplateHashCode, "onAnnotationLabelTemplateRender", b, null)
};
...
primitives.common.Graphics.prototype.text = function (a, b, c, d, e, g, f, h, j) {
    ...
    default:
        f["border-collapse"] = "collapse", b = {
            ...
            padding: 0
        }, a = this.m_cache.get(i.name, i.activeLayer.name, "textintable"), null === a ? (a = jQuery("<table><tbody><tr><td></td></tr></tbody></table>"), primitives.common.css(a, f), a.find("td").css(b).html(e), i.activeLayer.canvas.append(a), this.m_cache.put(i.name, i.activeLayer.name, "textintable", a)) : (primitives.common.css(a, f), a.find("td").css(b).html(e))
    }
};
...
primitives.common.Graphics.prototype.rightAngleLine = function (a, b, c, d, e) {
    ...
    a = this.m_cache.get(g.name, g.activeLayer.name, "rect");
...
primitives.common.CanvasGraphics.prototype.begin = function () {
    ...
    for (a in this.m_placeholders) if (this.m_placeholders.hasOwnProperty(a)) for (c in b = this.m_placeholders[a], e = b.size.width, g = b.size.height, b.layers) b.layers.hasOwnProperty(c) && (d = b.layers[c], null !== d.canvascanvas && d.canvascontext.clearRect(0, 0, e, g))
};
...
primitives.common.CanvasGraphics.prototype.polyline = function (a, b) {
    ...
    if (c.hasGraphics) {
        ...
        if (null != b.lineType) {
            ...
            void 0 !== c.setLineDash ? c.setLineDash(e) : void 0 !== c.webkitLineDash ? c.webkitLineDash = e : void 0 !== c.mozDash && (c.mozDash = e)
        }
        c.beginPath();
        ...
        case 0:
            ...
            break;
        case 4:
            d.width == d.height && d.width / 2 <= d.cornerRadius ? (c.moveTo(Math.round(d.x) + d.width + 0.5, Math.round(d.y) + d.height / 2 + 0.5), c.arc(Math.round(d.x) + d.width / 2 + 0.5, Math.round(d.y) + d.height / 2 + 0.5, Math.round(d.width / 2), 0, 2 * Math.PI, !1)) : 0 == d.cornerRadius ? (c.moveTo(Math.round(d.x) + 0.5, Math.round(d.y) + 0.5), c.lineTo(Math.round(d.x + d.width) + 0.5, Math.round(d.y) + 0.5), c.lineTo(Math.round(d.x + d.width) + 0.5, Math.round(d.y + d.height) + 0.5), c.lineTo(Math.round(d.x) + 0.5, Math.round(d.y + d.height) + 0.5), c.lineTo(Math.round(d.x) + 0.5, Math.round(d.y) + 0.5)) : (g = Math.min(d.cornerRadius, Math.min(d.width / 2, d.height / 2)), c.moveTo(Math.round(d.x) + 0.5, Math.round(d.y + g) + 0.5), c.arc(Math.round(d.x + g) + 0.5, Math.round(d.y + g) + 0.5, Math.round(g), Math.PI, -Math.PI / 2, !1), c.lineTo(Math.round(d.x + d.width - g) + 0.5, Math.round(d.y) + 0.5), c.arc(Math.round(d.x + d.width - g) + 0.5, Math.round(d.y + g) + 0.5, Math.round(g), -Math.PI / 2, 0, !1), c.lineTo(Math.round(d.x + d.width) + 0.5, Math.round(d.y + d.height - g) + 0.5), c.arc(Math.round(d.x + d.width - g) + 0.5, Math.round(d.y + d.height - g) + 0.5, Math.round(g), 0, Math.PI / 2, !1), c.lineTo(Math.round(d.x + g) + 0.5, Math.round(d.y + d.height) + 0.5), c.arc(Math.round(d.x + g) + 0.5, Math.round(d.y + d.height - g) + 0.5, Math.round(g), Math.PI / 2, Math.PI, !1), c.lineTo(Math.round(d.x) + 0.5, Math.round(d.y + g) + 0.5));
            break;
        case 2:
            c.quadraticCurveTo(Math.round(d.cpX) + 0.5, Math.round(d.cpY) + 0.5, Math.round(d.x) + 0.5, Math.round(d.y) + 0.5);
            break;
        case 3:
...
primitives.common.SvgGraphics.prototype.polyline = function (a, b) {
    ...
    if (null != b.lineType) switch (e = Math.round(b.lineWidth) || 1, b.lineType) {
    case 0:
    ...
    case 0:
        ...
        break;
    case 2:
        e += "Q" + (Math.round(f.cpX) + 0.5) + " " + (Math.round(f.cpY) + 0.5) + " " + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y) + 0.5);
        break;
    case 4:
        f.width == f.height && f.width / 2 <= f.cornerRadius ? (h = f.width / 2, e += "M" + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y) + f.height / 2 + 0.5), e += "A" + h + " " + h + " 0 0 0 " + (Math.round(f.x + f.width) + 0.5) + " " + (Math.round(f.y) + f.height / 2 + 0.5), e += "A" + h + " " + h + " 0 0 0 " + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y) + f.height / 2 + 0.5)) : 0 == f.cornerRadius ? (e += "M" + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y) + 0.5), e += "L" + (Math.round(f.x + f.width) + 0.5) + " " + (Math.round(f.y) + 0.5), e += "L" + (Math.round(f.x + f.width) + 0.5) + " " + (Math.round(f.y + f.height) + 0.5), e += "L" + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y + f.height) + 0.5), e += "L" + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y) + 0.5)) : (h = Math.min(f.cornerRadius, Math.min(f.width / 2, f.height / 2)), e += "M" + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y + h) + 0.5), e += "A" + Math.round(h) + " " + Math.round(h) + " 0 0 1 " + (Math.round(f.x + h) + 0.5) + " " + (Math.round(f.y) + 0.5), e += "L" + (Math.round(f.x + f.width - h) + 0.5) + " " + (Math.round(f.y) + 0.5), e += "A" + Math.round(h) + " " + Math.round(h) + " 0 0 1 " + (Math.round(f.x + f.width) + 0.5) + " " + (Math.round(f.y + h) + 0.5), e += "L" + (Math.round(f.x + f.width) + 0.5) + " " + (Math.round(f.y + f.height - h) + 0.5), e += "A" + Math.round(h) + " " + Math.round(h) + " 0 0 1 " + (Math.round(f.x + f.width - h) + 0.5) + " " + (Math.round(f.y + f.height) + 0.5), e += "L" + (Math.round(f.x + h) + 0.5) + " " + (Math.round(f.y + f.height) + 0.5), e += "A" + Math.round(h) + " " + Math.round(h) + " 0 0 1 " + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y + f.height - h) + 0.5), e += "L" + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y + h) + 0.5));
        break;
    case 3:
        e += "C" + (Math.round(f.cpX1) + 0.5) + " " + (Math.round(f.cpY1) + 0.5) + " " + (Math.round(f.cpX2) + 0.5) + " " + (Math.round(f.cpY2) + 0.5) + " " + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y) + 0.5)
    }
    d.setAttribute("d", e);
...
primitives.common.VmlGraphics.prototype.text = function (a, b, c, d, e, g, f, h, j) {
    ...
    default:
        ...
        case 1:
            ...
            l = new primitives.common.Point(d.horizontalCenter(), d.y);
            break;
        case 2:
        ...
        a.setAttribute("v", " m" + k.x + "," + k.y + " l" + l.x + "," + l.y + " e");
        ...
        null === e ? (e = jQuery(c.create(this.ie8mode)), i.activeLayer.canvas.append(e), this.m_cache.put(i.name, i.activeLayer.name, "vmltext", e)) : c.update(e[0], this.ie8mode)
    }
};
primitives.common.VmlGraphics.prototype.polyline = function (a, b) {
    ...
    if (null != b.lineType) {
        ...
        switch (b.lineType) {
        case 0:
            d.setAttribute("dashstyle", "Solid");
            break;
        case 1:
    ...
    null === d ? (d = jQuery(g.create(this.ie8mode)), c.activeLayer.canvas.append(d), this.m_cache.put(c.name, c.activeLayer.name, e, d)) : g.update(d[0], this.ie8mode)
};
...
primitives.orgdiagram.BaseController.prototype._drawHighlight = function () {
    var a, b, c, d;
    null !== this._highlightTreeItem && (this.graphics.activate("placeholder", 3), a = this._highlightTreeItem.actualPosition, b = new primitives.common.Rect(0, 0, Math.round(this._highlightTreeItem.actualSize.width), Math.round(this._highlightTreeItem.actualSize.height)), c = this._highlightTreeItem.template.highlightPadding, b.offset(c.left, c.top, c.right, c.bottom), d = new primitives.common.RenderEventArgs, d.context = this._highlightTreeItem.itemConfig, d.isCursor = this._highlightTreeItem.isCursor, d.isSelected = this._highlightTreeItem.isSelected, d.templateName = this._highlightTreeItem.template.name, this.transform.transformRect(a.x, a.y, a.width, a.height, !0, this, function (a, c, f, h) {
        1 == this._highlightTreeItem.actualVisibility ? this.graphics.template(a, c, f, h, b.x, b.y, b.width, b.height, this._highlightTreeItem.template.highlightTemplate, this._highlightTreeItem.template.highlightTemplateHashCode, this._highlightTreeItem.template.highlightTemplateRenderName, d, null) : this.graphics.template(a, c, f, h, b.x, b.y, b.width - 1, b.height - 1, this._highlightTreeItem.template.dotHighlightTemplate, this._highlightTreeItem.template.dotHighlightTemplateHashCode, null, d, null)
    }))
};
...
primitives.orgdiagram.BaseController.prototype._redrawTreeItems = function () {
    ...
    for (g in this._treeItems) this._treeItems.hasOwnProperty(g) && (a = this._treeItems[g], b = a.orgItem, c = this._treeLevels[a.level], a.setActualPosition(c, this.options), this.transform.transformRect(a.actualPosition.x, a.actualPosition.y, a.actualPosition.width, a.actualPosition.height, !0, this, function (g, i, j, p) {
        ...
        case 1:
            ...
            this.graphics.template(g, i, j, p, a.contentPosition.x, a.contentPosition.y, a.contentPosition.width, a.contentPosition.height, a.template.itemTemplate, a.template.itemTemplateHashCode, a.template.itemTemplateRenderName, d, {
            ...
            0 == this.options.showLabels && (k = new primitives.common.Label, k.text = b.title, k.position = new primitives.common.Rect(g, i, j, p), k.weight = 1E4, k.labelType = 1, c.labels.push(k));
...
primitives.orgdiagram.BaseController.prototype._redrawLabels = function () {
    ...
    if (0 == this.options.showLabels) {
        ...
        for (f = this._treeLevels.length - 1; 0 < f; f -= 1) a = this._treeLevels[f - 1], b = this._treeLevels[f], null != a.labelsRect && null != b.labelsRect && a.labelsRect.overlaps(b.labelsRect) && (b.showLabels = !1);
        f = 0;
        for (h = this._treeLevels.length; f < h; f += 1) if (e = this._treeLevels[f], a = e.labels, e.showLabels) {
            d = 0;
            for (g = a.length; d < g; d += 1) if (b = a[d], b.isActive) for (e = d + 1; e < g; e += 1) if (c = a[e], c.isActive) if (b.position.overlaps(c.position)) if (b.weight >= c.weight) 0 == c.labelType && (c.isActive = !1);
            else {
    ...
    f = 0;
    for (h = this._treeLevels.length; f < h; f += 1) if (e = this._treeLevels[f], e.showLabels || e.hasFixedLabels) {
        a = e.labels;
        d = 0;
        for (g = a.length; d < g; d += 1) if (b = a[d], b.isActive) switch (b.labelType) {
        case 0:
        case 2:
...
primitives.orgdiagram.BaseController.prototype._createLabel = function (a, b, c, d, e) {
    ...
    if (!primitives.common.isNullOrEmpty(i.label)) {
        ...
        case 0:
            ...
            break;
        case 1:
            h = new primitives.common.Label, h.weight = 1E4, h.labelType = 2
        }
        if (null != h) {
            h.text = i.label;
            ...
            case 11:
                ...
                break;
            case 3:
                h.position = new primitives.common.Rect(a + c + j, b + d / 2 - f / 2, g, f);
                switch (h.labelOrientation) {
                case 0:
                    h.horizontalAlignmentType = 1;
                    h.verticalAlignmentType = 1;
            ...
            case 12:
                ...
                case 1:
                    ...
                    break;
                case 2:
                    h.horizontalAlignmentType = 1, h.verticalAlignmentType = 2
                }
                break;
            case 5:
...
primitives.orgdiagram.BaseController.prototype._getConnectionsGraph = function () {
    ...
    for (c = this._treeLevels.length; b < c; b += 1) {
        ...
        for (e = a.treeItems.length; d < e; d += 1) {
            ...
            g = 0;
            for (f = j.length; g < f; g += 1) i = j[g], k.hasOwnProperty(h.id) || (k[h.id] = {}), k[h.id][i] = 1 == f ? {
                id: h.id
            } : {
                id: h.id,
                partnerid: i
...
primitives.orgdiagram.BaseController.prototype._drawAnnotations = function () {
    ...
    case 0:
        if (null != k.fromItem && null != k.toItem && (e = this._treeItemsByUserId[k.fromItem], g = this._treeItemsByUserId[k.toItem], null != e && null != g)) {
            ...
            f.panelSize = a.size;
            this.transform.transformRect(e.actualPosition.x, e.actualPosition.y, e.actualPosition.width, e.actualPosition.height, !0, this, function (a, b, c, d) {
...
primitives.orgdiagram.BaseController.prototype._redrawConnector = function (a, b, c, d) {
    ...
    1 >= c.partnerConnectorOffset && 0 == c.childrenConnectorOffset ? b.selectPalette(0) : 1 < c.partnerConnectorOffset ? b.selectPalette(c.partnerConnectorOffset - 1) : b.selectPalette(d.partnerConnectorOffset + d.childrenConnectorOffset - c.childrenConnectorOffset);
    (-1 > c.parentsConnectionsLeftIndex || 1 < c.parentsConnectionsRightIndex) && this.transform.transformPoints(c.actualPosition.horizontalCenter() + this.options.lineItemsInterval * (c.parentsConnectionsLeftIndex + 1), c.actualPosition.top(), c.actualPosition.horizontalCenter() + this.options.lineItemsInterval * (c.parentsConnectionsRightIndex - 1), c.actualPosition.top(), !0, this, function (a, c, d, e) {
    ...
    if (0 < c.visualChildren.length || 0 < c.extraChildren.length) {
        ...
        if (0 < d.length) {
            for (j = 0; j < d.length; j += 1) {
                ...
                f.actualPosition.horizontalCenter() < k ? (p = f.parentsConnectionsRightIndex * this.options.lineItemsInterval, 0 == f.parentsConnectionsRightIndex && (f.parentsConnectionsLeftIndex -= 1), f.parentsConnectionsRightIndex += 1) : (p = f.parentsConnectionsLeftIndex * this.options.lineItemsInterval, 0 == f.parentsConnectionsLeftIndex && (f.parentsConnectionsRightIndex += 1), f.parentsConnectionsLeftIndex -= 1);
                p = new primitives.orgdiagram.ConnectorPoint(f.actualPosition.horizontalCenter() + p, f.actualPosition.top());
                p.isSquared = h;
        ...
        e || this.transform.transformPoints(k, l, k, m, !0, this, function (a, d, e, f) {
            ...
            this.showElbowDots && 1 < c.partners.length && r.push(new primitives.common.DotSegment(a, d, 1, 1, 0.5));
...
primitives.orgdiagram.BaseController.prototype._drawTopConnectors = function (a, b, c, d, e) {
    ...
    if (e) {
        i = [];
        g = 0;
        for (h = d.length; g < h; g += 1) if (j = d[g], j.x < b && !j.isSquared) i.push(j);
        else break;
        h = i.length;
        0 < h && (i[h - 1].connectorStyleType = this._drawAngularConnectors(a, b, c, i, !1), l = Math.max(l, i[h - 1].connectorStyleType));
        i = [];
        for (f = d.length - 1; f >= g; f -= 1) if (j = d[f], j.x > b && !j.isSquared) i.push(j);
        else break;
        h = i.length;
        0 < h && (i[h - 1].connectorStyleType = this._drawAngularConnectors(a, b, c, i, !1), l = Math.max(l, i[h - 1].connectorStyleType));
        ...
        e = {};
        n = {};
        for (k in primitives.common.ConnectorStyleType) primitives.common.ConnectorStyleType.hasOwnProperty(k) && (e[primitives.common.ConnectorStyleType[k]] = b, n[primitives.common.ConnectorStyleType[k]] = b);
        i = Math.max(0, g - 1);
        ...
        }), d = k), k = n[i], null != k && k > b && (this.transform.transformPoints(k, c, b, c, !0, this, function (a, b, c, d) {
            m.push(new primitives.common.MoveSegment(a, b));
            m.push(new primitives.common.LineSegment(c, d))
        }), b = k)
...
primitives.orgdiagram.BaseController.prototype._drawAngularConnectors = function (a, b, c, d, e) {
    ...
    case 1:
        this.transform.transformPoint(h.x, h.y, !0, this, function (a, b) {
            i.push(new primitives.common.LineSegment(a, b))
        });
        break;
    case 2:
...
primitives.orgdiagram.BaseController.prototype._getTreeItemForMousePosition = function (a, b) {
    ...
    this.transform.transformPoint(a, b, !1, this, function (a, b) {
        d = 0;
        for (e = this._treeLevels.length; d < e; d += 1) if (f = this._treeLevels[d], b > f.topConnectorShift && b <= f.connectorShift) {
            j = h = null;
            k = 0;
            for (g = f.treeItems.length; k < g; k += 1) switch (i = this._treeItems[f.treeItems[k]], i.actualVisibility) {
            case 1:
                if (i.actualPosition.contains(a, b)) {
                    c = i;
                    return
                }
            case 2:
...
primitives.orgdiagram.BaseController.prototype._drawHighlightAnnotation = function () {
    ...
    case 1:
        ...
        l ? (d = new a.Rect(this.m_scrollPanel.scrollLeft(), this.m_scrollPanel.scrollTop(), Math.min(this.m_scrollPanelRect.width - 25, this.m_placeholderRect.width), Math.min(this.m_scrollPanelRect.height - 25, this.m_placeholderRect.height)), this.graphics.activate("placeholder", 7), this.transform.transformRect(b.actualPosition.x, b.actualPosition.y, b.actualPosition.width, b.actualPosition.height, !0, this, function (l, p, q, r) {
            g = new a.Rect(l, p, q, r);
            f = new a.Point(g.horizontalCenter(), g.verticalCenter());
            1 != this._highlightTreeItem.actualVisibility || !d.overlaps(g) ? (i = !a.isNullOrEmpty(c.calloutTemplateName) ? c.calloutTemplateName : !a.isNullOrEmpty(c.templateName) ? c.templateName : !a.isNullOrEmpty(this.options.defaultCalloutTemplateName) ? this.options.defaultCalloutTemplateName : this.options.defaultTemplateName, k = this._templates[i], null == k && (k = this._defaultTemplate), h = this._getAnnotationPosition(f, d, k.itemSize), e = new a.Rect(h), e.addRect(f.x, f.y), e.offset(50), m = e.getCSS(), m.display = "inherit", m.visibility = "inherit", this.m_calloutPlaceholder.css(m), f.x -= e.x, f.y -= e.y, h.x -= e.x, h.y -= e.y, j = new a.RenderEventArgs, j.context = b.itemConfig, j.isCursor = b.isCursor, j.isSelected = b.isSelected, j.templateName = k.name, this.graphics.resize("calloutplaceholder", e.width, e.height), this.graphics.activate("calloutplaceholder", 9), this.graphics.template(h.x, h.y, h.width, h.height, 0, 0, h.width, h.height, k.itemTemplate, k.itemTemplateHashCode, k.itemTemplateRenderName, j, null), this.pointerPlacement = 0, this.m_calloutShape.cornerRadius = this.options.calloutCornerRadius, this.m_calloutShape.offset = this.options.calloutOffset, this.m_calloutShape.opacity = this.options.calloutOpacity, this.m_calloutShape.lineWidth = this.options.calloutLineWidth, this.m_calloutShape.pointerWidth = this.options.calloutPointerWidth, this.m_calloutShape.borderColor = this.options.calloutBorderColor, this.m_calloutShape.fillColor = this.options.calloutfillColor, this.m_calloutShape.draw(f, h)) : this.m_calloutPlaceholder.css({
                display: "none",
                visibility: "hidden"
            })
        })) : this.m_calloutPlaceholder.css({
...
primitives.orgdiagram.BaseController.prototype._positionTreeItems = function () {
    ...
    if (0 < this._treeLevels.length) {
        ...
        default:
            ...
            d.offset(0, 0, 5, 5);
            b = this._setTreeLevelsVisibilityAndPositionTreeItems(c, 0);
            if (!this._checkDiagramSize(b, d) && (e = 0, b = this._setTreeLevelsVisibilityAndPositionTreeItems(c, c.length - 1), this._checkDiagramSize(b, d))) {
...
primitives.orgdiagram.BaseController.prototype._setOffset = function (a) {
    ...
    if (0 < a.visualChildren.length) {
        ...
        if (0 < c) this._offsetItemChildren(a, c);
            ...
            for (b = h.visualChildren.length - 1; 0 <= b; b -= 1) if (j = h.visualChildren[b], j === a) d = [];
            else if (null !== d) if (g = this._getGapBetweenSiblings(j, a), e[j.id] = g, 0 < g) d.splice(0, 0, j);
            else {
                f = j;
                break
            }
...
primitives.orgdiagram.BaseController.prototype._getChildrenOffset = function (a) {
    ...
    if (null === a.visualAggregatorId) {
        ...
        case 2:
            ...
            break;
        case 0:
            c = (d.offset + e.offset + e.actualSize.width) / 2
        }
...
primitives.orgdiagram.BaseController.prototype._recalcLevelsDepth = function () {
    ...
    for (b = this._treeLevels.length; a < b; a += 1) {
        ...
        k = [];
        c = 0;
        for (d = e.length; c < d; c += 1) f = this._treeItems[e[c]], h.depth = Math.max(h.depth, f.actualSize.height), h.actualVisibility = Math.min(h.actualVisibility, f.actualVisibility), (0 < f.partners.length || 0 < f.extraPartners.length) && i.push(new primitives.orgdiagram.TreeItemsGroup(f)), 0 < f.extraChildren.length && k.push(new primitives.orgdiagram.TreeItemsGroup(f)), f.connectorPlacement & 1 && (f.parentsConnectionsRightIndex = 1, f.parentsConnectionsLeftIndex = -1);
        if (0 < i.length) {
            c = 0;
            for (d = i.length; c < d; c += 1) {
                ...
                e = 0;
                for (g = m.length; e < g; e += 1) j = this._treeItems[m[e]], j = j.offset + j.actualSize.width / 2, l.startIndex = null != l.startIndex ? Math.min(l.startIndex, j) : j, l.endIndex = null != l.endIndex ? Math.max(l.endIndex, j) : j
            }
        ...
        if (0 < k.length) {
            ...
            for (d = k.length; c < d; c += 1) {
                ...
                i.push(f.id);
                e = 0;
                for (g = i.length; e < g; e += 1) j = this._treeItems[i[e]], j = j.offset + j.actualSize.width / 2, l.startIndex = null != l.startIndex ? Math.min(l.startIndex, j) : j, l.endIndex = null != l.endIndex ? Math.max(l.endIndex, j) : j
            }
...
primitives.orgdiagram.BaseController.prototype._addExtraConnections = function () {
    ...
    for (a in this._orgChildren) if (this._orgChildren.hasOwnProperty(a) && null != this._orgChildren[a]) {
        g = this._treeItemsByUserId[a];
...
primitives.orgdiagram.BaseController.prototype._createVisualTreeItem = function (a) {
    ...
    if (null != g) {
        h = 0;
        for (e = g.length; h < e; h += 1) if (c = g[h], this.showInvisibleSubTrees || this._hasVisibleChildren(c)) {
            ...
            case 2:
                ...
                if (a.connectorPlacement & 2) c = this._findLeftSiblingIndex(d.visualChildren, a), d.visualChildren.splice(c + 1, 0, b), b.connectorPlacement = 6, b.gravity = 2;
    ...
    default:
        if (null !== a.visualParentId) {
            d = this._treeItems[a.visualParentId];
            for (h = j; h < d.visualChildren.length - i; h += 1) if (e = d.visualChildren[h], e.id == a.id) b.push(e);
    ...
    if (0 < a.visualChildren.length && (i = this._getAdvisersDepth(a), 1 < i)) {
        e = a;
    ...
    h = 0;
    for (e = g.length; h < e; h += 1) if (c = g[h], 1 < c) {
        f = 0;
        for (j = d[h].length; f < j; f += 1) if (k = d[h][f], 0 < k.visualChildren.length) for (i = c; 1 < i;) k = this._createNewVisualAggregator(k), i -= 1
    }
...
primitives.orgdiagram.BaseController.prototype._layoutPartners = function (a, b) {
    ...
    if (1 < b.length) {
        ...
        if (0 < g.length) {
            ...
            i.visualChildren = g;
            d = 0;
            for (e = g.length; d < e; d += 1) h = g[d], h.visualParentId = i.id;
            d = 0;
...
primitives.orgdiagram.BaseController.prototype._defineLogicalParent = function (a, b) {
    var c = [],
        ...
        e, g = [],
        f, h;
    if (4 === a.visibility) for (d = d.concat(a.logicalParents); 0 < d.length;) {
        f = 0;
...
primitives.orgdiagram.BaseController.prototype._getAdvisersDepth = function (a) {
    ...
    if (null !== c) {
        ...
        for (d = a + 1; d < c.visualChildren.length; d += 1) if (e = c.visualChildren[d], e.connectorPlacement & 8) b = Math.max(b, this._getItemDepth(e));
        else break;
        for (d = a - 1; 0 <= d; d -= 1) if (e = c.visualChildren[d], e.connectorPlacement & 2) b = Math.max(b, this._getItemDepth(e));
        else break
    }
    return b
};
...
primitives.orgdiagram.BaseController.prototype._layoutChildren = function (a, b, c, d) {
    ...
    switch (b) {
    case 2:
        0 < e.visualChildren.length && (this._treeItems[e.visualChildren[0]].relationDegree = 1);
        break;
    case 3:
        if (3 < e.visualChildren.length) {
            ...
            for (l = 0; l < k; l += 1) {
                ...
                for (m = 0; m < i; m += 1) {
                    ...
                    if (null !== b || null !== f) h = this._getNewTreeItem({
                        visibility: 4,
                        visualParentId: g.id,
...
primitives.orgdiagram.BaseController.prototype._findRightSiblingIndex = function (a, b) {
    var c = null,
        d, e, g, f, h = {};
    e = 0;
    for (g = a.length; e < g; e += 1) if (d = a[e], null === c) {
        if (d === b) {
            c = g;
            h[b] = !0;
            d = 0;
...
primitives.orgdiagram.BaseController.prototype._showSelectedItems = function () {
    ...
    b = 0;
    for (c = this.options.selectedItems.length; b < c; b += 1) if (a = this._treeItemsByUserId[this.options.selectedItems[b]], null != a) switch (a.isSelected = !0, 0 === a.visibility && (a.visibility = 1), this.options.selectionPathMode) {
    case 1:
...
primitives.orgdiagram.BaseController.prototype._showCursorNeigbours = function () {
    ...
    if (null !== this._cursorTreeItem) {
        ...
        a = 0;
        for (b = this._cursorTreeItem.logicalParents.length; a < b; a += 1) {
...
primitives.famdiagram.ShapeAnnotationConfig = function (a) {
    ...
    switch (arguments.length) {
    case 1:
        if (null !== a) if (a instanceof Array) this.items = a;
        else if ("object" == typeof a) for (b in a) a.hasOwnProperty(b) && (this[b] = a[b])
    }
};
...
primitives.famdiagram.Controller.prototype._createOrgTree = function () {
    ...
    if (0 < this.options.items.length) {
        a = 0;
        for (b = this.options.items.length; a < b; a += 1) d = this.options.items[a], null != d && (this._treeItemConfigs[d.id] = d, f = new primitives.famdiagram.FamilyItem, f.id = d.id, f.itemConfig = d, this._famItems[f.id] = f, this._famItemsNonExtracted[f.id] = f, this.maximumFamItemId = Math.max(this.maximumFamItemId, d.id));
        for (c in this._famItems) if (this._famItems.hasOwnProperty(c)) {
            f = this._famItems[c];
            f.logicalParents = null != f.itemConfig.parents ? f.itemConfig.parents.slice(0) : [];
            e = {};
            a = 0;
            for (b = f.logicalParents.length; a < b; a += 1) d = f.logicalParents[a], this._famItems.hasOwnProperty(d) && d != f.id && !e.hasOwnProperty(d) ? (this._famItems[d].logicalChildren.push(f.id), e[d] = !0) : f.logicalParents.splice(primitives.common.indexOf(f.logicalParents, d), 1)
        }
        a = 0;
        ...
        for (b = this.options.items.length; a < b; a += 1) {
            ...
            c = 0;
            for (d = k.length; c < d; c += 1) if (h = this._famItems[k[c]], f.level + 1 < h.level) {
                m = h.logicalParents;
                e = 0;
                ...
                l[h.level] = h;
                e = 0;
                for (g = m.length; e < g; e += 1) i = this._famItems[m[e]], i.level <= f.level ? (l[f.level + 1].logicalParents.push(i.id), i.logicalChildren.push(l[f.level + 1].id)) : (l[i.level + 1].logicalParents.push(i.id), i.logicalChildren.push(l[i.level + 1].id))
            }
            for (k = f.logicalChildren.slice(0); 0 < k.length;) {
                m = {};
                f = [];
                c = 0;
                for (d = k.length; c < d; c += 1) if (h = this._famItems[k[c]], !1 == h.isVisible && (e = h.logicalParents.sort().toString(), !primitives.common.isNullOrEmpty(e))) if (m.hasOwnProperty(e)) {
                    n = m[e];
                    e = 0;
                    for (g = h.logicalParents.length; e < g; e += 1) i = this._famItems[h.logicalParents[e]], l = primitives.common.indexOf(i.logicalChildren, h.id), i.logicalChildren.splice(l, 1);
                    h.logicalParents = [];
        ...
        if (0 < this._families.length) {
            ...
            for (b = this._families.length; a < b; a += 1) {
                e = this._families[a];
                c = 0;
                for (d = e.links.length; c < d; c += 1) g = e.links[c], h = this._famItems[g.fromItem].familyId, i = this._famItems[g.toItem].familyId, h != i && (j.hasOwnProperty(h) || (j[h] = {}), j[h].hasOwnProperty(i) || (j[h][i] = 0), j[h][i] += 1, j.hasOwnProperty(i) || (j[i] = {}), j[i].hasOwnProperty(h) || (j[i][h] = 0), j[i][h] += 1), this._families[i].backLinks.push(new primitives.famdiagram.FamLink(g.toItem, g.fromItem))
            }
            for (; f.length < this._families.length;) {
                a = 0;
                for (b = this._families.length; a < b; a += 1) if (e = this._families[a], !k.hasOwnProperty(e.id)) if (h = this._findMaximumSpanningTree(j, e.id), h.hasOwnProperty(e.id)) {
                    ...
                    c = 0;
                    for (d = i.length; c < d; c += 1) {
                        l = this._getFamilyAndItsSubFamilies(i[c], h);
                        e = 0;
        ...
        for (b = f.length; a < b; a += 1) {
            ...
            for (c = 0; c < j.length; c += 1) if (g = j[c], m = this._orgItems[g.toItem], !0 == d[m.familyId]) {
                for (g = e.items[0]; m.level >= g.level;) m = this._orgItems[m.parent];
...
primitives.famdiagram.Controller.prototype._sumOrgItems = function () {
    ...
    for (g = this.maximumLevel; g >= this.minimumLevel; g -= 1) if (a = c[g], null != a) {
        d = 0;
        for (e = a.length; d < e; d += 1) b = a[d], null != b.parent && (this._orgItems[b.parent].weight += b.weight)
    }
};
primitives.famdiagram.Controller.prototype._balanceChildrenForItem = function (a, b) {
    ...
    for (b.childIndex = 0; 0 < q.length;) {
        j = 0;
        for (i = q.length; j < i; j += 1) if (r = q[j], c = {}, this._orgItemChildren.hasOwnProperty(r.id)) {
            ...
            if (0 < s.length) {
                ...
                case 0:
                    ...
                    if (a.hasOwnProperty(k.id)) {
                        m = a[k.id];
                        g = 0;
                        for (f = m.length; g < f; g += 1) l = m[g], n = l.fromParent, p = l.toParent, l.commonParent == r.id ? n != p && (c.hasOwnProperty(n) || (c[n] = {}), c[n].hasOwnProperty(p) || (c[n][p] = 0), c[n][p] += 1) : this._orgItems[n].childIndex < this._orgItems[p].childIndex ? k.rightLink += 1 : k.leftLink += 1
                    }
                ...
                if (null != h) {
                    ...
                    d = this._sortOrgItemsInSpanningTree(h, d, c, 0, !1);
                    c = 0;
...
primitives.famdiagram.Controller.prototype._sortOrgItemsInSpanningTree = function (a, b, c, d, e) {
    ...
    if (null != f) {
        ...
        h = f = 0;
        for (j = g.length; h < j; h += 1) i = g[h], k = i.totalRightLink - i.totalLeftLink, k * a.weight < e * i.totalWeight || k * a.weight == e * i.totalWeight && 0 < f ? (i = this._sortOrgItemsInSpanningTree(i, b, c, i.connections, !1), d = i.concat(d), f -= 1) : (i = this._sortOrgItemsInSpanningTree(i, b, c, i.connections, !0), d = d.concat(i), f += 1)
    } else d = [a];
    return d
};
...
primitives.famdiagram.Controller.prototype._getExtraGravity = function () {
    var a, b, c = {},
        d, e, g, f, h;
    for (a in this._orgChildren) if (this._orgChildren.hasOwnProperty(a)) {
        b = this._orgItems[a];
...
primitives.famdiagram.Controller.prototype._compareArrays = function (a, b) {
    ...
    if (a.length != b.length) c = !1;
        ...
        b.sort();
        d = 0;
        for (e = a.length; d < e; d += 1) if (a[d] != b[d]) {
            c = !1;
            break
        }
    }
...
primitives.famdiagram.Controller.prototype._findLargestRoot = function () {
    ...
    for (h = this.maximumLevel; h >= this.minimumLevel; h -= 1) if (e = d[h], null != e) {
        g = 0;
...
primitives.famdiagram.Controller.prototype._sortItemsBylevels = function (a) {
    for (var b, c, d, e, g, f = this._getParentEdges(a), h = this._getChildrenEdges(a); 0 < f.length || 0 < h.length;) {
        ...
        a = 0;
        for (b = f.length; a < b; a += 1) c = this._famItems[f[a].parent], d = this._famItems[f[a].child], null == c.level ? (c.level = this._getMinimumLevel(c.logicalChildren) - 1, e = e.concat(this._getParentEdges(c)), g = g.concat(this._getChildrenEdges(c))) : d.level <= c.level && this._shiftChartItem(d, c.level - d.level + 1);
        f = e;
        h = g
    }
};
...
primitives.orgdiagram.Controller.prototype._createOrgTree = function () {
    ...
    if (null != this.options.items && 0 < this.options.items.length) {
        ...
        j = new primitives.orgdiagram.ItemConfig;
        c = 0;
...
primitives.orgdiagram.TreeItem.prototype.setActualSize = function (a, b) {
    ...
    case 1:
        ...
        this.isCursor && (this.actualSize.height += this.template.cursorPadding.top + this.template.cursorPadding.bottom, this.actualSize.width += this.template.cursorPadding.left + this.template.cursorPadding.right, this.contentPosition.x = this.template.cursorPadding.left, this.contentPosition.y = this.template.cursorPadding.top);
