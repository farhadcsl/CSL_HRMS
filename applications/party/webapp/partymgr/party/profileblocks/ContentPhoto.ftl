    ...
    <div class="screenlet-body" >
     <#list partyContent as pContent>
        ...
        <#if !pContent_has_next && pcType.partyContentTypeId=="INTERNAL">
			...
			<div id='profile-photo'><img height="200px" width="175px" src="https://hrms.computerservicesltd.com/humanres/control/img/${content.contentName}?imgId=${content.dataResourceId}"/></div>
		</#if>
		
	</#list>
	<div class="ContentPhoto">
	 <#if security.hasPermission("HUMANRES_EXEC", session)>
