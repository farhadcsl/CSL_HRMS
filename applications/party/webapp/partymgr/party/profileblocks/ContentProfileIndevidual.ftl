  ...
  <div id="partyContent" class="screenlet">
    ...
    <div class="screenlet-body">
      ...
      <form id="uploadPartyContent" method="post" enctype="multipart/form-data" action="<@ofbizUrl>IndividualuploadContessaContent?partyId=${parameters.partyId}</@ofbizUrl>">
    ...
    ${screens.render("component://party/widget/partymgr/ProfileScreens.xml#ContentProfileList")}
      <hr />
  </div>
