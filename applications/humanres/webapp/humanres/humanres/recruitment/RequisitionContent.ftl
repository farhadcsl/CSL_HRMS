  ...
  <div id="partyContent" class="screenlet">
    ...
    <div class="screenlet-body">
      ...
      <form id="uploadPartyContent" method="post" enctype="multipart/form-data" action="<@ofbizUrl>uploadPositionRequisitionContent?jobRequisitionId=${jobRequisitionId}</@ofbizUrl>">
        ...
        <input type="file" name="uploadedFile" class="required error" size="25" required="required"/>
         <input type="hidden" name="jobRequisitionId" value="${jobRequisitionId?if_exists}"/>
