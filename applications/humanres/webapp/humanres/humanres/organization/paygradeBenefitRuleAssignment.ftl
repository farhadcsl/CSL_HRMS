...
<div id="paygradeBenefitRuleAssignment" class="screenlet">
    ...
    <div class="screenlet-body">
        ...
        <form method="post" id="myform"  name="LookupUserLoginAndPartyDetails"  action="<@ofbizUrl>paygradeBenefitRuleAssignment</@ofbizUrl>" class="basic-form">
    ...
    $('#myform').submit(function(){
	   ...
	   $(this).attr('action', "<@ofbizUrl>paygradeBenefitRuleAssignment</@ofbizUrl>"); // Set the action here. 
	}); 
    </script>
