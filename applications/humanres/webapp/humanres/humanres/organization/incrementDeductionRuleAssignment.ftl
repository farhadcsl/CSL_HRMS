<div id="incrementDeductionRuleAssignment" class="screenlet">
    <div class="screenlet-title-bar">
        <ul>
            <li class="h3">Increment Deduction Rule Assignment</li>
    ...
    <div class="screenlet-body">
        ...
        <form method="post" id="myform"  name="LookupUserLoginAndPartyDetails"  action="<@ofbizUrl>incrementDeductionRuleAssignment</@ofbizUrl>" class="basic-form">
    ...
    $('#myform').submit(function(){
	   ...
	   $(this).attr('action', "<@ofbizUrl>incrementDeductionRuleAssignment</@ofbizUrl>"); // Set the action here. 
	}); 
    </script>
