  ...
  <div id="partyContent" class="screenlet">
    <div class="screenlet-title-bar">
      <ul>
        <li class="h3">Documents of ${company.groupName}</li>
      </ul>
      <br class="clear" />
    </div>
    ...
    <div class="screenlet-body">
      ...
      <form id="uploadPartyContent" method="post" enctype="multipart/form-data" action="<@ofbizUrl>uploadOrganizationContent</@ofbizUrl>">
