...
public class UtilAttendancePreference {
	...
	private static Logger logger=Logger.getLogger("UtilAttendancePreference");
		 ...
		 */
		public static String getPreferencePropertyValue1(String partyId,Delegator delegator,Date date,String orgPartyId,String selectedProperty) throws GenericEntityException{
		...
		//	
			...
			GenericValue dayAttendancePreference = EntityUtil.getFirst(dayAttendancePreferences);
		//	
			//First Day Preference
			String tempDayPrefValue=null;
			tempDayPrefValue=getPropertyFromDayPreference(delegator, date, orgPartyId,selectedProperty);
			
			if (tempDayPrefValue != null&& !tempDayPrefValue.isEmpty()) {
				//Check For Roster 
				String tempRosterPrefValue=null;
				tempRosterPrefValue=getPropertyFromRosterPreference(partyId, delegator, date, orgPartyId, selectedProperty);
				if (tempRosterPrefValue != null&& !tempRosterPrefValue.isEmpty()) {
					value=tempRosterPrefValue;
				}else{
					value=tempDayPrefValue;	
				}
			}else{
				
				//For Employee Preference
				String tempEmployeePrefValue=null;
				tempEmployeePrefValue=getPropertyFromEmployeePreference(partyId, delegator, date, orgPartyId, selectedProperty);
				
				if (tempEmployeePrefValue != null&& !tempEmployeePrefValue.isEmpty()) {
					value=tempEmployeePrefValue;		
				}else{
					...
					if (tempRosterPrefValue != null&& !tempRosterPrefValue.isEmpty()) {
						...
						String tempDesignationPrefValue=null;
						tempDesignationPrefValue=getPropertyFromDesignationPreference(partyId, delegator, date, orgPartyId, selectedProperty);
						if (tempDesignationPrefValue != null&& !tempDesignationPrefValue.isEmpty()) {
							value=tempDesignationPrefValue;
						}else{
							//For Organization Preference
							String tempOrganizationPrefValue=null;
							tempOrganizationPrefValue=getPropertyFromOrganizationPreference(delegator, date, orgPartyId, selectedProperty);
							if (tempOrganizationPrefValue != null&& !tempOrganizationPrefValue.isEmpty()) {
								value=tempOrganizationPrefValue;
							}
		 ...
		 * @throws GenericEntityException
		 */
		public static String getPropertyFromDayPreference(Delegator delegator,Date date,String orgPartyId,String selectedProperty) throws GenericEntityException{
			String value="";
			...
			if (UtilValidate.isNotEmpty(dayAttendancePreference)) {
				if(dayAttendancePreference.getString(selectedProperty)!=null&&!dayAttendancePreference.getString(selectedProperty).isEmpty()){
					value=dayAttendancePreference.getString(selectedProperty);
				}
			}
		 ...
		 * @throws GenericEntityException
		 */
		public static String getPropertyFromEmployeePreference(String partyId,Delegator delegator,Date date,String orgPartyId,String selectedProperty) throws GenericEntityException{
			String value="";
			...
			GenericValue employeeAttendancePreference = EntityUtil.getFirst(employeeAttendancePreferences);
			if (UtilValidate.isNotEmpty(employeeAttendancePreference)) {
				if(employeeAttendancePreference.getString(selectedProperty)!=null&&!employeeAttendancePreference.getString(selectedProperty).isEmpty()){
					value=employeeAttendancePreference.getString(selectedProperty);
				}
			}
		 ...
		 * @throws GenericEntityException
		 */
		public static String getPropertyFromRosterPreference(String partyId,Delegator delegator,Date date,String orgPartyId,String selectedProperty) throws GenericEntityException{
			String value="";
			...
			if(UtilValidate.isNotEmpty(rosterEmp)){
				...
				GenericValue rosterPref = EntityUtil.getFirst(rosterPrefs);
				if (UtilValidate.isNotEmpty(rosterPref)) {
					if(rosterPref.getString(selectedProperty)!=null&&!rosterPref.getString(selectedProperty).isEmpty()){
						value=rosterPref.getString(selectedProperty);
					}
				}
			}
		 ...
		 * @throws GenericEntityException
		 */
		public static String getPropertyFromDesignationPreference(String partyId,Delegator delegator,Date date,String orgPartyId,String selectedProperty) throws GenericEntityException{
			String value="";
			...
			GenericValue designPrefEmplposition = EntityUtil.getFirst(designPrefEmplpositions);	
			...
			if(UtilValidate.isNotEmpty(designPrefEmplposition)){
				...
				GenericValue designAttendancePreference = EntityUtil.getFirst(designationPreferences);
				if (UtilValidate.isNotEmpty(designAttendancePreference)) {
					if(designAttendancePreference.getString(selectedProperty)!=null&&!designAttendancePreference.getString(selectedProperty).isEmpty()){
						value=designAttendancePreference.getString(selectedProperty);
					}
				}
		 ...
		 * @throws GenericEntityException
		 */
		public static String getPropertyFromOrganizationPreference(Delegator delegator,Date date,String orgPartyId,String selectedProperty) throws GenericEntityException{
			String value="";
			...
			if(UtilValidate.isNotEmpty(orgAttendancePreference)){
				if(orgAttendancePreference.getString(selectedProperty)!=null&&!orgAttendancePreference.getString(selectedProperty).isEmpty()){
					value=orgAttendancePreference.getString(selectedProperty);
				}
			}
		...
		public static GenericValue getDesignationPreference(String partyId,Delegator delegator,Date date,String orgPartyId) throws GenericEntityException{
			...
			logger.debug("designPrefCodition----------->"+designPrefCodition+"     fromDate----->"+date+"        emplPositionId--->"+emplPositionId);
			List<GenericValue> designPrefEmplpositions=delegator.findList("DesignPrefEmplposition", designPrefCodition, null, null, null, false);
			logger.debug("designPrefEmplpositions---->"+designPrefEmplpositions);
