...
public class ListComparator implements Comparator<Map <String, Object>>{
	...
	public int compare(Map<String, Object> o1, Map<String, Object> o2) {
		...
		String employeeId1 = (String) o1.get("EmployeeId");
		String employeeId2 = (String) o2.get("EmployeeId");
		//checking employeeId null or not
		if(UtilValidate.isEmpty(employeeId1)){
			employeeId1 = (String) o1.get("employeeId");
			if(UtilValidate.isEmpty(employeeId1)){
				employeeId1 = (String) o1.get("PIN");
				if(UtilValidate.isEmpty(employeeId1)){
					employeeId1 = "";
				}
			}
		...
		if(UtilValidate.isEmpty(employeeId2)){
			employeeId2 = (String) o2.get("employeeId");
			if(UtilValidate.isEmpty(employeeId2)){
				employeeId2 = (String) o2.get("PIN");
				if(UtilValidate.isEmpty(employeeId2)){
					employeeId2 = "";
				}
			}
		...
		String department1 = (String) o1.get("Department");
		String department2 = (String) o2.get("Department");
		
		//checking department null or not
		if(UtilValidate.isEmpty(department1)){
			department1 = (String) o1.get("department");
			if(UtilValidate.isEmpty(department1)){
				department1 = "";
			}
		}
		...
		if(UtilValidate.isEmpty(department2)){
			department2 = (String) o2.get("department");
			if(UtilValidate.isEmpty(department2)){
				department2 = "";
			}
		}
