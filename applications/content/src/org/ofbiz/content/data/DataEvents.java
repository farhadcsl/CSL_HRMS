...
public class DataEvents {
    ...
    public static String serveContessaImage(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (!"Y".equals(dataResource.getString("isPublic"))) {
                ...
                EntityExpr isOwner= EntityCondition.makeCondition( EntityCondition.makeCondition("partyId", EntityOperator.EQUALS,userLogin.get("partyId")),EntityOperator.AND,EntityCondition.makeCondition("dataResourceId", EntityOperator.EQUALS,dataResourceId));
                EntityExpr hasAdminRole= EntityCondition.makeCondition( EntityCondition.makeCondition("roleTypeId", EntityOperator.EQUALS,"CONTENT_ADMIN"),EntityOperator.AND,EntityCondition.makeCondition("dataResourceId", EntityOperator.EQUALS,dataResourceId));
                EntityExpr exp = EntityCondition.makeCondition(isOwner,EntityOperator.OR,hasAdminRole);
                List<GenericValue> contentAndRoleList = delegator.findList("ContentAndRole",exp,null,null,null,true);
