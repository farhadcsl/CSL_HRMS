package org.ofbiz.workflow.trainingAndDevelopmentProcess;
...
//Created By Tutul
public class TrainingAndDevelopmentWorkflowConfig {
    public static final String module = TrainingAndDevelopmentWorkflowConfig.class.getName();

    public static String createTrainingAndDevelopmentProcessStructureSetup(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (processName.equals("")) {
            request.setAttribute("_ERROR_MESSAGE_", "Training And Development Structure Name can not be empty");
            return "error";
        }
		...
		processStructureIn.put("processType", "TrainingAndDev");
        ...
        request.setAttribute("_EVENT_MESSAGE_", "Training And Development Structure Successfully Created");
        return "success";
    }

    public static String updateTrainingAndDevelopmentProcessStructureSetup(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (processStrId.equals("")) {
            request.setAttribute("_ERROR_MESSAGE_", "Training And Development Structure Id can not be empty");
            return "error";
        }
        String processName = "";
        if (null != request.getParameter("processName")) {
        ...
        request.setAttribute("_EVENT_MESSAGE_", "Training And Development Structure Successfully Updated");
        return "success";
    }
    ...
    public static String createPartyProcess(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (processStrId.equals("")) {
            request.setAttribute("_ERROR_MESSAGE_", "Structure Id can not be empty");
            return "error";
        }
    ...
    public static String statusChangePartyProcess(HttpServletRequest request, HttpServletResponse response) {
		...
		Map<String, Object> partyProcessIn = FastMap.newInstance();
		partyProcessIn.put("processStrId", processStrId);
		partyProcessIn.put("processTypeId", "TrainingAndDev");
		partyProcessIn.put("employeeId", employeeId);
		partyProcessIn.put("partyId", partyId);
		partyProcessIn.put("comments", comments);
